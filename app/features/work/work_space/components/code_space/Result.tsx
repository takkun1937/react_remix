...
export const  Result = (): JSX.Element => {
    ...
    const handleCompile = () => {
        ...
        const options = {
            method: "POST",
            url: window.ENV.REACT_APP_RAPID_API_URL,
            params: { base64_encoded: "true", fields: "*" },
            headers: {
              "content-type": "application/json",
              "Content-Type": "application/json",
              "X-RapidAPI-Host": window.ENV.REACT_APP_RAPID_API_HOST,
              "X-RapidAPI-Key": window.ENV.REACT_APP_RAPID_API_KEY,
            },
            data: formData,
        };
    ...
    const checkStatus = async (token: string) => {
        const options = {
            method: "GET",
            url: window.ENV.REACT_APP_RAPID_API_URL + "/" + token,
            params: { base64_encoded: "true", fields: "*" },
            headers: {
                "X-RapidAPI-Host": window.ENV.REACT_APP_RAPID_API_HOST,
                "X-RapidAPI-Key": window.ENV.REACT_APP_RAPID_API_KEY,
